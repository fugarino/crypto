  ...
  return (
    <ProtectedRoute>
      <section className="px-4 xs:px-8 sm:px-12 max-w-[1400px] mx-auto w-screen">
        ...
        <div className="h-[85vh] min-h-[450px] max-h-[900px]">
          <section className="h-full">
            <div className="flex h-full">
              ...
              <article className="w-full h-full lg:w-[50%]">
                <div className="bg-white rounded-lg lg:rounded-lg shadow-md h-full w-full flex flex-col justify-center items-center">
