const FilterBtns = ({
  ...
  return (
    <ul className="absolute -bottom-11 md:bottom-auto md:-top-[3.5rem] md:right-4 flex w-full xs:w-auto justify-between xs:justify-center xs:space-x-16 text-[#67676d] text-[0.9rem] mt-4">
      <li
